 ...
 * @author Attila Mate
 */
public class ReferencedObjectChange extends ChangeItem {

  /**
   * The change event of the reference.
   */
  private final ObjectChangeSimple change;

  ReferencedObjectChange(String path, String name, ObjectChangeSimple change) {
    super(path, name);
    this.change = change;
  }
   ...
   * The change event of the reference.
   */
  public final ObjectChangeSimple getChange() {
    return change;
  }
