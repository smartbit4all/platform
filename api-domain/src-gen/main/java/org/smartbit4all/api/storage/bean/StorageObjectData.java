/*
 * storage api The storage api is a generic possibility to store and load objects.
 *
...
/**
 * The basic data object of the storages. This holds the version history and refers the current
 * version. Also has named references and collections.
 */
@ApiModel(
    description = "The basic data object of the storages. This holds the version history and refers the current version. Also has named references  and collections. ")
@JsonPropertyOrder({
...
public class StorageObjectData {
  ...
  @ApiModelProperty(required = true,
      value = "The uri of the object represented by the storage object. ")
  @JsonProperty(URI)
  ...
  /**
   * The fully qualified name of the bean class. Normally the URI of the given object can contain
   * the class but also the StorageObjectData contains it. If we have this in the StorageObjectData
   * then we use this. If it is missing then we try to figure out from the URI.
   * 
   * @return className
   **/
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "The fully qualified name of the bean class. Normally the URI of the given object can contain the class but also the StorageObjectData contains it. If we have this in the StorageObjectData then we use this. If it is missing then we try to figure out from the URI. ")
  ...
  /**
   * The deleted flag is set when the given object is deleted. The deletion is always logical so we
   * know that the object exists but we also know that it is already inactivated.
   * 
   * @return deleted
   **/
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "The deleted flag is set when the given object is deleted. The deletion is always logical so we know that the object exists but we also know that it is already inactivated. ")
