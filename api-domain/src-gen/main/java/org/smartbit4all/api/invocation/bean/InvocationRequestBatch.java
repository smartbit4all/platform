...
@JsonPropertyOrder({
  InvocationRequestBatch.REQUESTS
})
@JsonTypeName("InvocationRequestBatch")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InvocationRequestBatch {
  public static final String REQUESTS = "requests";
  private List<InvocationRequest> requests = new ArrayList<>();

  public InvocationRequestBatch() { 
  }

  public InvocationRequestBatch requests(List<InvocationRequest> requests) {
    
    this.requests = requests;
    return this;
  }

  public InvocationRequestBatch addRequestsItem(InvocationRequest requestsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    InvocationRequestBatch invocationRequestBatch = (InvocationRequestBatch) o;
    return Objects.equals(this.requests, invocationRequestBatch.requests);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvocationRequestBatch {\n");
