/*
 * Grid api The grid api is resposible for the grid components that shows a list of item.
 *
...
/**
 * The configuration of the grid view. It can be a simple table grid but a complex card
 * representation also. A model has one or more view option to render the content.
 */
@ApiModel(
    description = "The configuration of the grid view. It can be a simple table grid but a complex card representation also. A model has one or more view option to render the content. ")
@JsonPropertyOrder({
...
public class GridViewDescriptor {
  ...
  /**
   * In the table the columns are the columns of the table. In the tree the columns can be used to
   * append the title of a tree node.
   * 
   * @return columns
   **/
  ...
  @ApiModelProperty(required = true,
      value = "In the table the columns are the columns of the table. In the tree the columns can be used to append the title of a tree node. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, gridViewDescriptor.label) &&
        ...
        Objects.equals(this.preserveSelectionOnPageChange,
            gridViewDescriptor.preserveSelectionOnPageChange)
        &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(label, icon, kind, columns, selectionMode, selectionType,
        preserveSelectionOnPageChange, showEditColumns, highlightProperty, highlightClass);
  }
  ...
  public String toString() {
    ...
    sb.append("    preserveSelectionOnPageChange: ")
        .append(toIndentedString(preserveSelectionOnPageChange)).append("\n");
