...
/**
 * This definition object is a descriptor about the master data management in an application.
 * Typically this is a single instance in the application but there can be more then one if we would
 * like to manage separated set of data like in a multi tenant application. It is used as
 * CollectionApi.reference to be able to identify by name.
 */
@ApiModel(
    description = "This definition object is a descriptor about the master data management in an application. Typically this is a single instance in the application but there can be more then one if we would like to manage separated set of data like in a multi tenant application. It is used as CollectionApi.reference to be able to identify by name. ")
@JsonPropertyOrder({
    MDMDefinition.URI,
    MDMDefinition.NAME,
...
public class MDMDefinition {
  ...
  @ApiModelProperty(
      value = "The logical name of the given mdm definition. This is also the default name of the schema.")
  @JsonProperty(NAME)
  ...
  /**
   * The name of the administration group. If a user is involved in the group then can adminiter all
   * the entries inside the definition. The entries will have their own security group that will be
   * included into this group. So be can manage all the entries one by one. It is mandatory to set
   * this group name or else the master data management won&#39;t be able to setup the rights.
   * 
   * @return adminGroupName
   **/
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "The name of the administration group. If a user is involved in the group then can adminiter all the entries inside the definition. The entries will have their own security group that will be included into this group. So be can manage all the entries one by one. It is mandatory to set this group name or else the master data management won't be able to setup the rights. ")
  ...
  /**
   * The reference to the current state of the definition. It contains the necessary runtime
   * informations.
   * 
   * @return state
   **/
  ...
  @Valid
  @ApiModelProperty(
      value = "The reference to the current state of the definition. It contains the necessary runtime informations.")
  @JsonProperty(STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
