 ...
 */
@ApiModel(description = "This inline object is hold information about modification state and notes to one entry. ")
@JsonPropertyOrder({
...
public class MDMModificationItem {
  ...
  **/
  ...
  public MDMModificationItem notes(List<MDMModificationNote> notes) {
