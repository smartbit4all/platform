...
public class MDMEntryDescriptor {
  ...
  public List<@Valid MDMEntryConstraint> getConstraints() {
    return constraints;
  }
  ...
  @JsonProperty(CONSTRAINTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConstraints(List<@Valid MDMEntryConstraint> constraints) {
    this.constraints = constraints;
  }
  ...
  public List<@Valid MDMTableColumnDescriptor> getTableColumns() {
    return tableColumns;
  }
  ...
  @JsonProperty(TABLE_COLUMNS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTableColumns(List<@Valid MDMTableColumnDescriptor> tableColumns) {
    this.tableColumns = tableColumns;
  }
