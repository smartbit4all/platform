 ...
 * fields. All these classes will be discovered and managed by the <code>OrgApi</code>. If we want
 * to manage security groups then we must have a class implementing this interface. It must have
 * fields for the available groups.
 * 
