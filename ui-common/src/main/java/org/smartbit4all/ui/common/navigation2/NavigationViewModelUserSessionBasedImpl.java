...
public class NavigationViewModelUserSessionBasedImpl extends ViewModelImpl<TreeModel>
  ...
  protected Object getValueForCommand(String commandPath, String commandCode, Class<?> clazz,
    ...
    if (TOGGLE.equals(commandCode) ||
      ...
      return getWrappedTreeNode(commandPath);
    }
    return super.getValueForCommand(commandPath, commandCode, clazz, params);
  }
  ...
  public static NavigationViewModel createForUI(Navigation navigation,
    ...
    NavigationViewModelUserSessionBasedImpl result =
        new NavigationViewModelUserSessionBasedImpl(publisherWrapper, uiNavigationApi,
            userSessionApi);
  ...
  public static NavigationViewModel createAsChild(ViewModel parent, String path,
    ...
    if (impl instanceof NavigationViewModelUserSessionBasedImpl) {
      NavigationViewModelUserSessionBasedImpl viewModelImpl =
          (NavigationViewModelUserSessionBasedImpl) impl;
