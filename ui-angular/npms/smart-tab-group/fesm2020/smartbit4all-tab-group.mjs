...
import * as i1 from '@smartbit4all/navigation';
...
class TabGroupComponent {
    ...
    navigateTabContent($event) {
        ...
        this.navigationService.navigateTo([`${this.tabTiles[$event.index].url}`], undefined, "preserve", true);
    }
    getTabIndex() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: TabGroupComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.SmartNavigationService }]; }, propDecorators: { tabTiles: [{
                type: Input
            }], route: [{
                type: Input
            }] } });
