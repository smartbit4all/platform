...
import org.smartbit4all.ui.vaadin.util.css.PointerEvents;
import org.smartbit4all.ui.vaadin.util.css.Shadow;
import org.smartbit4all.ui.vaadin.util.css.TextAlign;
import org.smartbit4all.ui.vaadin.util.css.TextOverflow;
...
public class UIUtils {
  ...
  public static void showErrorNotification(String message) {
    ...
    setTextColor(TextColor.ERROR, content);
  ...
  public static void setMargin(Size size, Component... components) {
    for (Component component : components) {
  ...
  public static void setPadding(Size size, Component... components) {
    for (Component component : components) {
  ...
  public static void setZIndex(int index, Component... components) {
    for (Component component : components) {
      component.getElement().getStyle().set("z-index", String.valueOf(index));
    }
  }
