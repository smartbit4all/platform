...
@CssImport("./styles/components/application/menu-holder.css")
@JsModule("./swipe-away.js")
public class MenuHolder extends Div implements AfterNavigationObserver {

  private String CLASS_NAME = "menu-holder";
  ...
  public MenuHolder(String title, String imageName) {
    this.title = title;
  ...
  private void initHeader(String imageName) {
    mainContent.add(new MainLogo(title, imageName));
  }
