...
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (100, '100', 'Case 100', '1', '2', NULL, 'uri-100');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (110, '110', 'Case 110', '1', '2', '100', 'uri-110');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (111, '111', 'Case 111', '1', '2', '110', 'uri-111');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (112, '112', 'Case 112', '1', '2', '110', 'uri-112');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (200, '200', 'Case 200', '1', null, null, 'uri-200');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (300, '300', 'Case 300', '1', null, null, 'uri-300');
		  
-- the ticket 400 series contains a single primary person to each person, no secondary person.
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (401, '401', 'Case 401', '1', null, null, 'uri-401');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (402, '402', 'Case 402', '2', null, null, 'uri-402');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (403, '403', 'Case 403', '3', null, null, 'uri-403');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (404, '404', 'Case 404', '4', null, null, 'uri-404');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (405, '405', 'Case 405', '5', null, null, 'uri-405');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (406, '406', 'Case 406', '6', null, null, 'uri-406');
INSERT INTO TICKET (ID, ID_STRING, TITLE, PRIMARY_PERSON_ID, SECONDARY_PERSON_ID, PARENT_ID, URI) 
		  VALUES (407, '407', 'Case 407', '7', null, null, 'uri-407');
