 ...
 * we have the source value then we {@link #app2ext(Object)}. If we have the target and would like
 * to have the source then we {@link #ext2app(Object)}.
 * 
 * 
 * @author Peter Boros
 ...
 *
 */
public interface DataConverter<APPDOMAINTYPE, EXTERNALTYPE> {
  ...
  /**
   * The inversion of the {@link #app2ext(Object)}. Receives the target value and produces the
   * source.
   * 
   * @param extValue
   * @return
