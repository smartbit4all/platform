...
public final class PropertyFunction {
   ...
   *
   * @param functionName It is required to set the function name. Function names must start with an
   *        alphabetic letter and can be max 30 characters long with numbers, $, # and underscore
   *        characters allowed.
   */
   ...
   * property itself. </br>
   * Example: <br>
   * <code>PropertyFunction.withSelfPropertyArgument("UPPER")</code> may result an
   * <code>UPPER(myProperty)</code> function.
   *
   * @param functionName It is required to set the function name. Function names must start with an
   *        alphabetic letter and can be max 30 characters long with numbers, $, # and underscore
   *        characters allowed.
  ...
  public static final class Builder {
    ...
    // This regular expression validates whether there is any inline or block comment, basic sql
    // statment, text block, statement break
     ...
     *
     * @param functionName It is required to set the function name. Function names must start with
     *        an alphabetic letter and can be max 30 characters long with numbers, $, # and
    ...
    /**
     * @return functionName_transformedParameterString_propertyName1_propertyName2 and the parameter
     *         string is transformed like: 0-1-paramstring-2
     */
