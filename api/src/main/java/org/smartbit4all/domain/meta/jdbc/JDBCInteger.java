...
/**
 * The interface of the {@link Integer} value based types.
 * 
 * @author Zoltan Suller
 */
public interface JDBCInteger extends JDBCDataConverter<Integer, Integer> {
