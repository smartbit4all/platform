...
public interface ObjectStorage {
   ...
   * @param options When loading we can instruct the loading to retrieve the necessary data only.
   */
  <T> List<StorageObject<T>> loadBatch(Storage storage, List<URI> uris, Class<T> clazz,
      StorageLoadOption... options);

  List<StorageObject<?>> loadBatch(Storage storage, List<URI> uris, StorageLoadOption... options);
