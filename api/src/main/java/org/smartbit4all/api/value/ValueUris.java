...
public class ValueUris extends UriUtils {
  ...
  public static final String VALUE_SCHEME_PREFIX = "value:";
   ...
   * 
   * @param source The identifier of the source that provides the values.
   * @param objectCode The identifier of the object that the can hold values.
   * @return
   */
   ...
   * 
   * @param source The identifier of the source that provided the value
   * @param objectCode The identifier of the element the value belongs to. For example it can be an
   *        id of a selector field.
