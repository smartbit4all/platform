...
import org.smartbit4all.api.binarydata.ExternalResourceApi;
import org.smartbit4all.api.binarydata.ExternalResourceApiImpl;
...
public class BinaryDataConfig {
  ...
  @Bean
  public ExternalResourceApi externalResourceApi() {
    return new ExternalResourceApiImpl();
  }
