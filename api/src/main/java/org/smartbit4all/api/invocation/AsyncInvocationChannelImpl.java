...
public final class AsyncInvocationChannelImpl implements AsyncInvocationChannel {
  ...
  public void invoke(InvocationRequest request) {
    executorService.submit(() -> {
      ...
      } else if (request.getSessionUri() != null) {
        sessionManagementApi.setSession(request.getSessionUri());
      }
      try {
