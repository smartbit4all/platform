...
public interface ObjectExtensionApi {
   ...
   *
   * <p>
   * The named object descriptor is simply reevaluated, and a default layout is generated based on
   * the property descriptors stored within. The created {@link ObjectLayoutDescriptor} is not
   * persisted.
   *
   * @param definitionName a unique {@code String} name of an existing {@link ObjectDescriptor}, not
   *        null
   * @return the {@link ObjectLayoutDescriptor} created by evaluating the property descriptors of
   *         the object descriptor, not null
   */
