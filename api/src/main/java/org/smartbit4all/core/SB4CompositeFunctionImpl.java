...
public class SB4CompositeFunctionImpl<I, O> extends SB4FunctionImpl<I, O>
  ...
  @Override
  public SB4ExecutionNode calls() {
    return rootNode;
  }

  @Override
  public SB4ExecutionNode preCalls() {
    if (preNode == null) {
      preNode = new SB4ExecutionNode(Mode.SEQUENTIAL);
    }
    return preNode;
  }

  @Override
  public SB4ExecutionNode postCalls() {
    if (postNode == null) {
      postNode = new SB4ExecutionNode(Mode.SEQUENTIAL);
    }
    return postNode;
  }
