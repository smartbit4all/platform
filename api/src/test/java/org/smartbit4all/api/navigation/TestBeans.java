...
public class TestBeans {
  ...
  public static TestBean1 bean1Of(String name, List<TestBean2> testBean2s) {
  ...
  public static TestBean2 bean2Of(String name, List<TestBean3> testBean3s) {
  ...
  public static TestBean3 bean3Of(String name, TestBean4 bean4) {
  ...
  public static TestBean4 bean4Of(String name) {
