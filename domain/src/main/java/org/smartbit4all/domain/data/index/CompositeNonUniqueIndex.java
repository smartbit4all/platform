 ...
 * @author Peter Boros
 */
public abstract class CompositeNonUniqueIndex extends TableDataIndex {
   ...
   */
  protected Map<CompositeValue, List<DataRow>> index = null;

  CompositeNonUniqueIndex(TableData<?> tableData) {
    super(tableData, IndexType.NONUNIQUE, true);
  }
