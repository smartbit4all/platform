...
public class ContentAccessSrvRestForDotNetTestConfig extends ContentAccessSrvRestTestConfig {
	...
	public ContentAccessSrvRestForDotNetTestConfig() throws URISyntaxException {
		...
		copyOfLoremIpsum = new URI(ContentAccessApi.SCHEME, null, "/upload/copy_of_lorem-ipsum.pdf", null);
	...
	ContentAccessApi contentAccessApi(ObjectShareApi objectShareApi, ObjectStorage<BinaryContent> objectStorage,
		...
		ContentAccessApi contentAccessApi = new ContentAccessApiImpl(objectShareApi, objectStorage, binaryContentApi);
