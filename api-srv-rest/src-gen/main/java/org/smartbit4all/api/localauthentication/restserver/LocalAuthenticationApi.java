...
@Validated
@Controller
@Tag(name = "LocalAuthentication", description = "the LocalAuthentication API")
public interface LocalAuthenticationApi {
    ...
    default ResponseEntity<Void> login(
        @Parameter(name = "LocalAuthenticationLoginRequest", description = "", required = true) @Valid @RequestBody LocalAuthenticationLoginRequest localAuthenticationLoginRequest
    ) throws Exception {
