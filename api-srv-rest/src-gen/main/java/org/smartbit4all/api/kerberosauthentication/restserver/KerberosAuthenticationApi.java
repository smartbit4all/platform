...
public interface KerberosAuthenticationApi {
     ...
     */
    @ApiOperation(value = "Logs in the user with the credentails given.", nickname = "login", notes = "", tags={ "KerberosAuthentication", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Void> login(@ApiParam(value = "", required = true) @Valid @RequestBody KerberosAuthenticationLoginRequest kerberosAuthenticationLoginRequest) throws Exception {
     ...
     */
    @ApiOperation(value = "Logs out the currently logged in user", nickname = "logout", notes = "", tags={ "KerberosAuthentication", })
    @ApiResponses(value = { 
