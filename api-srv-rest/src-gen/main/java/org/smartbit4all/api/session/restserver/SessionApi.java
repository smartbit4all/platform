...
public interface SessionApi {
    ...
    default ResponseEntity<SessionInfoData> refreshSession(
        @ApiParam(value = "", required = true) @Valid @RequestBody RefreshSessionRequest refreshSessionRequest
    ) throws Exception {
    ...
    @ApiOperation(
        tags = { "Session" },
        value = "Sets the locale of the session",
        nickname = "setLocale",
        notes = "Sets the locale of the current session and returns the SessionInfoData",
        response = SessionInfoData.class
    )
    @ApiResponses({
        @ApiResponse(code = 200, message = "Returns the existing session info", response = SessionInfoData.class),
