...
public class JwtUtil {
    ...
    public String createToken(String subject, OffsetDateTime expiration) {
        ...
        /**
         * This method creates the JwtToken based on the followings: - claims
         * (Map<String, Object>) -
         * subject (username)
         *
         * The JwtToken generated by this method contains the claims, the subject, the
         * creation date, an
         * expiration date (currently 10 hours), and all of this is signed with the
         * SECRET_KEY.
         *
