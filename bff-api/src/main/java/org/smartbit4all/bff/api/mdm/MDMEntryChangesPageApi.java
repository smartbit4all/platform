...
public interface MDMEntryChangesPageApi extends PageApi<Object> {
  ...
  // /**
  // * If the current user is administrator of the given entry then this action can be performed.
  // The
  // * action start an editing phase for the entries.
  // *
  // * @param viewUuid The unique identifier of the view in the current context.
  // * @param request The action request that contains every information about the triggering
  // action.
  // */
  ...
  // * If the current user is administrator of the given entry then this action can be performed.
  // The
  // * action publishes all the draft editing object and the changes will be available for every
  // user.
  // *
  // * @param viewUuid The unique identifier of the view in the current context.
  // * @param request The action request that contains every information about the triggering
