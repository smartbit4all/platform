...
public class ApiKeyEditorPageApiImpl extends MDMEntryEditPageApiImpl
  ...
  private SmartComponentLayoutDefinition getLayout() {
    ...
    SmartWidgetDefinition userCB = combobox(
        ApiKey.USER,
        localeSettingApi.get(APIKEY_CLASS_NAME, ApiKey.USER),
        selectionDefinition(ApiKeyConstants.APIKEY_USERS, Value.DISPLAY_VALUE));
    widgets.add(userCB);
    ...
    SmartWidgetDefinition expirationDtp = datetimePicker(
        ApiKey.EXPIRATION,
  ...
  public void performSave(UUID viewUuid, UiActionRequest request) {
    ...
    if (model.getUri() == null) {
      ...
      ObjectNode apiKeyNode = apiKeyInnerApi.createApiKey(model.getUser(), token,
    ...
    return new View()
        ...
        .eventHandlers(Arrays.asList(
            new ViewEventHandler()
                ...
                .invocationRequest(invocationApi.builder(ApiKeyEditorPageApi.class)
